...
public class Punctuation
{
	...
	{
		Punctuation pum = new Punctuation();
		pum.SearchIt();
	}
...
"May 13, 1940" +
"Mr. Speaker:" +
"On Friday evening last I received His Majesty’s commission to form anew " +
...
"But I take up my task with buoyancy and hope. I feel sure that our cause will not be suffered to fail among men. At this time I feel entitled to claim the aid of all, and I say, \"Come then, let us go forward together with our united strength.\"");
	...
	while(kb.hasNext())
	{
		...
		printWords(checkForPunctuation(print));
	...
	public String checkForPunctuation(String word)
	{
		...
		int len;
		len = word.length();
		if(word.charAt(0) == '.' || word.charAt(0) == ',' || word.charAt(0) == '"' || word.charAt(0) == '\'' || word.charAt(0) == ':' || word.charAt(0) == ';' || word.charAt(0) == '?')
			return word + " ";
		else if(word.charAt(len-1) == '.' || word.charAt(len-1) == ',' || word.charAt(len-1) == '"' || word.charAt(len-1) == '(' || word.charAt(len-1) == ':' || word.charAt(len-1) == ';' || word.charAt(len-1) == '?')
			return word + " ";
		else
			return "";
	...
	public void printWords(String word2)
	{
